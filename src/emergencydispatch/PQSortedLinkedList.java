        ...
        while (true) {
            ...
            if (option == 1) {
                ...
                if (priorityQueue.isEmpty()) {
                    ...
                    // Call nextDispatch() and print its return value
                    int nextPriority = priorityQueue.nextDispatch();
                    System.out.println("Next Dispatch Priority: " + nextPriority);
                    System.out.println("Incident: " + priorityQueue.head.reportedIncident +
